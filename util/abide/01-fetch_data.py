...
if __name__ == '__main__':
    ...
    parser.add_argument('--pipeline', default='cpac', type=str,
                        help='Pipeline to preprocess ABIDE data. Available options are ccs, cpac, dparsf and niak.'
                             ' default: cpac.')
    parser.add_argument('--atlas', default='cc400',
    ...
    parser.add_argument('--root_path', default="/data/CodeGoat24/cc400", type=str, help='The path of the folder containing the dataset folder.')
